parameters = [
  { name = "dev.frontend.catalogue_url", value = "http://dev-catalogue.devtb.online:80/", type = "String" },
  { name = "dev.frontend.user_url", value = "http://dev-user.devtb.online:80/", type = "String" },
  { name = "dev.frontend.cart_url", value = "http://dev-cart.devtb.online:80/", type = "String" },
  { name = "dev.frontend.shipping_url", value = "http://dev-shipping.devtb.online:80/", type = "String" },
  { name = "dev.frontend.payment_url", value = "http://dev-payment.devtb.online:80/", type = "String" },
  ...
  { name = "dev.shipping.cart_endpoint", value = "dev-cart.devtb.online:80", type = "String" },
